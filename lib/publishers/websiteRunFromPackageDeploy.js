    ...
    static execute(state, context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (context.appSettings.WEBSITE_RUN_FROM_PACKAGE_BLOB_MI_RESOURCE_ID) {
                utils_1.Logger.Info("Package Url will use RBAC.");
                bobUrl = packageUrl;
            }
            else {
                ...
                if (context.appSettings.AzureWebJobsStorage) {
                    ...
                    const sasParams = yield this.getBlobSasParams(blobServiceClient.accountName, blobName, containerClient.containerName, context);
